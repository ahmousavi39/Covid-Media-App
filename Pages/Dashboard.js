  ...
  return (
    <ScrollView>
      ...
      <View style={style.container}>
        ...
        <CustomTouchCard style={{ marginRight: 'auto', marginLeft: 'auto' }}>
          <TouchableOpacity style={[style.touchable, { backgroundColor: "purple" }]} onPress={() => props.navigation.navigate('Sources')}>
            <View style={style.imgCon}>
              <MaterialIcons name="source" size={50} color="black" />
            </View>
            <CustomText style={{ textAlign: 'center' }}>Sources</CustomText>
          </TouchableOpacity>
        </CustomTouchCard>
